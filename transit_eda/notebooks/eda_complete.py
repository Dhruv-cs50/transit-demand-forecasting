...
# sorted_exits/cumulative are ascending (low→high), so cumulative[top20_idx] is
# the share held by the bottom 80% of stations, not the top 20%. The top-20%
# share is the complement.
